///
/// See http://man7.org/linux/man-pages/man2/statfs.2.html, for example for filesystems identifiers
///
...
//////////////////////////////////////////////////////////////////////////////////////
/// from http://man7.org/linux/man-pages/man2/statfs.2.html; https://manpages.debian.org/testing/manpages-dev/statfs.2.en.html ;
#[cfg(all(
    target_os = "linux",
    not(target_env = "musl"),
    not(target_arch = "s390x")
))]
pub const BTRFS_SUPER_MAGIC: FsType = FsType(0x9123683e);
#[cfg(all(
    target_os = "linux",
    not(target_env = "musl"),
    not(target_arch = "s390x")
))]
pub const OVERLAYFS_SUPER_MAGIC: FsType = FsType(0x794c7630);
//////////////////////////////////////////////////////////////////////////////////////
...
impl Statfs {
    ...
    #[cfg(not(any(target_os = "openbsd", target_os = "ios", target_os = "macos")))]
...
pub fn statfs<P: ?Sized + NixPath>(path: &P) -> Result<Statfs, Errno> {
    unsafe {
...
pub fn fstatfs<T: AsRawFd>(fd: &T) -> Result<Statfs, Errno> {
    unsafe {
        let mut stat = mem::MaybeUninit::<libc::statfs>::uninit();
